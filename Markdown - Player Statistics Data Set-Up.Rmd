...
For those not *au-fait* with R, I have hosted the [app on Shiny Apps](https://perkot.shinyapps.io/afl-player-stats-dashboard/). As I am using a free-account, this link is subject to bandwidth limits, & may not work!
